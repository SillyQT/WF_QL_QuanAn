...
('NV002', N'Lê Hữu Tài', N'Nam', '2003-04-09', N'Số 11 Đường 27, TP. HCM', '0362111265', '2023-10-01', 100000),
('NV003', N'Nguyễn Quốc Tiến', N'Nam', '2003-01-17', N'17B Tân Trụ, TP. HCM', '0362111265', '2023-10-01', 150000),
('NV004', N'Huỳnh Công Huy', N'Nam', '2003-01-17', N'17B Tân Trụ, TP. HCM', '0362111265', '2023-10-01', 100000),
('NV005', N'Thanh Thảo', N'Nữ', '2003-01-17', N'17B Tân Trụ, TP. HCM', '0362111265', '2023-10-01', 100000)
GO
--Thêm tài khoản
--TENDANGNHAP VARCHAR(10) NOT NULL,
...
INSERT INTO TAIKHOAN(TENDANGNHAP, MANHANVIEN, TENHIENTHI, MATKHAU, CAPQUYEN, TRANGTHAI) VALUES
('admin', 'NV001', N'Cao Tấn Công', '1962026656160185351301320480154111117132155', N'Quản trị', N'Hoạt động'),
('lehuutai', 'NV002', N'Lê Hữu Tài', '1962026656160185351301320480154111117132155', N'Nhân viên', N'Hoạt động'),
('quoctien', 'NV003', N'Nguyễn Quốc Tiến', '1962026656160185351301320480154111117132155', N'Nhân viên', N'Hoạt động'),
('conghuy', 'NV004', N'Huỳnh Công Huy', '1962026656160185351301320480154111117132155', N'Nhân viên', N'Hoạt động'),
('thanhthao', 'NV005',  N'Thanh Thảo', '1962026656160185351301320480154111117132155', N'Nhân viên', N'Đã khóa')
GO
...
('NV001', '2023-10-02', N'Ca sáng'),
('NV001', '2023-10-02', N'Ca chiều'),
('NV001', '2023-10-03', N'Ca sáng'),
('NV001', '2023-10-03', N'Ca chiều'),
('NV001', '2023-10-04', N'Ca sáng'),
('NV001', '2023-10-04', N'Ca chiều'),
('NV002', '2023-10-02', N'Ca sáng'),
('NV002', '2023-10-02', N'Ca chiều'),
('NV002', '2023-10-03', N'Ca sáng'),
('NV002', '2023-10-03', N'Ca chiều'),
('NV002', '2023-10-04', N'Ca sáng'),
('NV002', '2023-10-04', N'Ca chiều')
GO
...
CREATE PROC USP_InsertAccount
    ...
    @grantPermissions NVARCHAR(50), 
    @status NVARCHAR(50)
AS
    BEGIN
        INSERT INTO TAIKHOAN(TENDANGNHAP, MANHANVIEN, TENHIENTHI, MATKHAU, CAPQUYEN, TRANGTHAI) VALUES
        (@userName, @staffid, @displayName, '1962026656160185351301320480154111117132155', @grantPermissions, @status)
    END
GO
...
AS
    BEGIN
        UPDATE TAIKHOAN
        SET CAPQUYEN = @grantPermissions, TRANGTHAI = @status
...
BEGIN
    ...
    BEGIN
        UPDATE NV
        SET LUONGCOBAN = CASE
                            WHEN TK.CAPQUYEN = N'Quản trị' THEN NV.LUONGCOBAN * 1.2
                            WHEN TK.CAPQUYEN = N'Nhân viên' THEN NV.LUONGCOBAN / 1.2
                            ELSE NV.LUONGCOBAN
                         END
        FROM NHANVIEN NV
